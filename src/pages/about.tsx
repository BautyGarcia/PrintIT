    ...
    <>
      ...
      >
        ...
        <div         
          className={
            largeScreen
              ? "font-family-Nunito mr-8 mt-20 flex w-full h-full justify-center"
...
//<div className="bg-[url('/img/TopAbout.png')]"></div>
  ...
  return (
    <form> 
      ...
      <div className={largeScreen ? "flex flex-row w-full h-full": "flex flex-col h-full w-full justify-center items-center"}>
        <div className={largeScreen ? "flex flex-col h-full w-1/2 ml-16 mt-16": "flex flex-col h-full w-full justify-center items-center"}>
        <h1>
          Como surgió PrintIT
        </h1>
        ...
        <div className={largeScreen ? "w-1/2 ml-20" : "hidden"}>
        <Image
          src="/AboutUsImg.png"
          width={700}
          height={600}
